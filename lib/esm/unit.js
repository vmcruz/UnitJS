...
function data(property, value2) {
  ...
  allOf({ values: [value2], typeOf: ["string"], allowEmptyString: true });
  this.__nodes__.forEach((node) => {
    node.dataset[camelProperty] = value2;
  });
  return this;
}
...
function text(text2) {
  ...
  allOf({ values: [text2], typeOf: ["string"], allowEmptyString: true });
  this.__nodes__.forEach((node) => {
